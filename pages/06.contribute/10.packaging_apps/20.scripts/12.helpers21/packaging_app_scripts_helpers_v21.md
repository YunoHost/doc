...
<details> <summary><i>Download, check integrity, uncompress and patch upstream sources</i></summary>
...
<details> <summary><i>Install a specific version of nodejs, using 'n'</i></summary>
...
<details> <summary><i>Remove the version of node used by the app.</i></summary>
...
<details> <summary><i>Install a specific version of Ruby using rbenv</i></summary>
...
<details> <summary><i>Remove the version of Ruby used by the app.</i></summary>
...
<details> <summary><i>Install a specific version of Go using goenv</i></summary>
...
<details> <summary><i>Remove the version of Go used by the app.</i></summary>
...
<details> <summary><i>Install and initialize Composer in the given directory</i></summary>
...
<details> <summary><i>Execute a command with Composer</i></summary>
...
<details> <summary><i>Run SQL instructions in a database ($db_name by default)</i></summary>
...
<details> <summary><i>Dump a database</i></summary>
...
<details> <summary><i>Execute a mongo command</i></summary>
...
<details> <summary><i>Check if a mongo database exists</i></summary>
...
<details> <summary><i>Restore a database</i></summary>
...
<details> <summary><i>Create a database, an user and its password. Then store the password in the app's config</i></summary>
...
<details> <summary><i>Remove a database if it exists, and the associated user</i></summary>
...
<details> <summary><i>Install MongoDB and integrate MongoDB service in YunoHost</i></summary>
...
<details> <summary><i>get the first available redis database</i></summary>
...
<details> <summary><i>Create a dedicated config file from a template</i></summary>
...
<details> <summary><i>Get a value from heterogeneous file (yaml, json, php, python...)</i></summary>
...
<details> <summary><i>Set a value into heterogeneous file (yaml, json, php, python...)</i></summary>
...
<details> <summary><i>Create a dedicated nginx config</i></summary>
...
<details> <summary><i>Remove the dedicated nginx config</i></summary>
...
<details> <summary><i>Regen the nginx config in a change url context</i></summary>
...
<details> <summary><i>Create a dedicated PHP-FPM config</i></summary>
...
<details> <summary><i>Remove the dedicated PHP-FPM config</i></summary>
...
<details> <summary><i>Create a dedicated systemd config</i></summary>
...
<details> <summary><i>Remove the dedicated systemd config</i></summary>
...
<details> <summary><i>Start (or other actions) a service,  print a log in case of failure and optionnaly wait until the service is completely started</i></summary>
...
<details> <summary><i>Create a dedicated fail2ban config (jail and filter conf files)</i></summary>
...
<details> <summary><i>Remove the dedicated fail2ban config (jail and filter conf files)</i></summary>
...
<details> <summary><i>Add a logrotate configuration to manage log files / log directory</i></summary>
...
<details> <summary><i>Remove the app's logrotate config.</i></summary>
...
<details> <summary><i>Execute a command after sudoing as $app</i></summary>
...
<details> <summary><i>Curl abstraction to help with POST requests to local pages (such as installation forms)</i></summary>
...
<details> <summary><i>Remove a file or a directory, checking beforehand that it's not a disastrous location to rm such as entire /var or /home</i></summary>
...
<details> <summary><i>Read the value of a key in the app's manifest</i></summary>
...
<details> <summary><i>Return the app upstream version, deduced from `$YNH_APP_MANIFEST_VERSION` and strippig the `~ynhX` part</i></summary>
...
<details> <summary><i>Return 0 if the "upstream" part of the version changed, or 1 otherwise (ie only the ~ynh suffix changed)</i></summary>
...
<details> <summary><i>Compare the current package version is strictly lower than another version given as an argument</i></summary>
...
<details> <summary><i>Compare the current package version is lower or equal to another version given as an argument</i></summary>
...
<details> <summary><i>Validate an IP address</i></summary>
...
<details> <summary><i>Check if the scripts are being run by the package_check in CI</i></summary>
...
<details> <summary><i>Retrieve a YunoHost user information</i></summary>
...
<details> <summary><i>Get the list of YunoHost users</i></summary>
...
<details> <summary><i>Get an application setting</i></summary>
...
<details> <summary><i>Set an application setting</i></summary>
...
<details> <summary><i>Set an application setting but only if the "$key" variable ain't set yet</i></summary>
...
<details> <summary><i>Delete an application setting</i></summary>
...
<details> <summary><i>Generate a random string</i></summary>
...
<details> <summary><i>Substitute/replace a string (or expression) by another in a file</i></summary>
...
<details> <summary><i>Substitute/replace a regex in a file</i></summary>
...
<details> <summary><i>Normalize the url path syntax</i></summary>
...
<details> <summary><i>Add a file or a directory to the list of paths to backup</i></summary>
...
<details> <summary><i>Restore a file or a directory from the backup archive</i></summary>
...
<details> <summary><i>Restore all files that were previously backuped in an app backup script</i></summary>
...
<details> <summary><i>Calculate and store a file checksum into the app settings</i></summary>
...
<details> <summary><i>Verify the checksum and backup the file if it's different</i></summary>
...
<details> <summary><i>Delete a file checksum from the app settings</i></summary>
...
<details> <summary><i>Print a message to stderr and terminate the current script</i></summary>
...
<details> <summary><i>Print an "INFO" message</i></summary>
...
<details> <summary><i>Print a warning on stderr</i></summary>
...
<details> <summary><i>Execute a command and redirect stderr to stdout</i></summary>
...
<details> <summary><i>Execute a command and redirect stderr in /dev/null. Print stderr on error.</i></summary>
...
<details> <summary><i>Print a progress bar showing the progression of an app script</i></summary>
...
<details> <summary><i>Initialize the multimedia directory system</i></summary>
...
<details> <summary><i>Add a directory in yunohost.multimedia</i></summary>
...
<details> <summary><i>Allow an user to have an write authorisation in multimedia directories</i></summary>
...
<details> <summary><i>Remove a permission for the app (note that when the app is removed all permission is automatically removed)</i></summary>
...
<details> <summary><i>Check if a permission exists</i></summary>
...
<details> <summary><i>Redefine the url associated to a permission</i></summary>
...
<details> <summary><i>Update a permission for the app</i></summary>
...
<details> <summary><i>Check if a permission has an user</i></summary>
...
<details> <summary><i>Define and install dependencies with a equivs control file</i></summary>
...
<details> <summary><i>Remove fake package and its dependencies</i></summary>
...
<details> <summary><i>Install packages from an extra repository properly.</i></summary>
...
<details> <summary><i>Check if a user exists on the system</i></summary>
...
<details> <summary><i>Check if a group exists on the system</i></summary>
...
<details> <summary><i>Create a system user</i></summary>
...
<details> <summary><i>Delete a system user</i></summary>
