...
Si vous utilisez un [domaine automatique](/administer/tutorials/domains/dns_nohost_me) fourni par le Projet YunoHost,
...
Si votre adresse IP publique change constamment, suivez ce [tutoriel](/administer/tutorials/domains/dns_dynamicip).
