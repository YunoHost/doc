...
- **Desventajas**: Probablemente necesitas [configurer manualmente tu router](/install/post_install/port_forwarding) y puede que [tu operador de internet te limite](/install/providers/isp/).
...
Puedes alquilar un servidor privado virtual (VPS) o una máquina dedicada a alojamientos [asociativos](https://db.ffdn.org/) o [comerciales](/install/providers/servers).
