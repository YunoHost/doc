...
- redirige los puertos siguiendo [esta documentación](/admin/get_started/post_install/port_forwarding) ;
- configura con cuidado los registros DNS del correo electrónico siguiendo [esta documentación](/admin/get_started/post_install/dns_config) ;
