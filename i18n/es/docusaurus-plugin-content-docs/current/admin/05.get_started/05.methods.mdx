...
- **Desventajas**: Probablemente necesitas [configurer manualmente tu router](/admin/get_started/post_install/port_forwarding) y puede que [tu operador de internet te limite](/admin/self_hosting/providers/isp/).
