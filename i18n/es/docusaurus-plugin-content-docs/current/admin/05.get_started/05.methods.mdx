...
- **Desventajas**: Probablemente necesitas [configurer manualmente tu router](/admin/get_started/post_install/port_forwarding) y puede que [tu operador de internet te limite](/admin/get_started/providers/isp/).
...
Puedes alquilar un servidor privado virtual (VPS) o una máquina dedicada a alojamientos [asociativos](https://db.ffdn.org/) o [comerciales](/admin/get_started/providers/servers).
