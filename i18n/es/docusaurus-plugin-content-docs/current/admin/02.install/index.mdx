...
- **Desventajas**: Probablemente necesitas [configurer manualmente tu router](/admin/install/post_install/port_forwarding) y puede que [tu operador de internet te limite](/admin/install/providers/isp/).
...
Puedes alquilar un servidor privado virtual (VPS) o una máquina dedicada a alojamientos [asociativos](https://db.ffdn.org/) o [comerciales](/admin/install/providers/servers).
