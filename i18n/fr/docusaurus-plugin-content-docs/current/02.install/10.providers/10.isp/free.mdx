...
[Liste des ports à ouvrir](/install/post_install/port_forwarding).

### Freebox ≤ v5

Cela se passe dans la section *Ma Freebox / Configurer mon routeur*. Il faut :

- Rediriger les [ports à ouvrir](/install/post_install/port_forwarding) vers l'adresse locale de votre serveur YunoHost.
