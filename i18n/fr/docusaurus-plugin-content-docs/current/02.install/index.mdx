...
=======
>>>>>>> 69dd6de9 (reuse translations: providers)
import Link from '@docusaurus/Link';
...
Vous pouvez louer un serveur privé virtuel ou une machine dédiée à des hébergeurs [associatifs](https://db.ffdn.org/) ou [commerciaux](/providers/servers).
