...
- **Inconvénients** : il vous faudra [configurer manuellement votre box internet](/install/post_install/port_forwarding) et serez possiblement [limité par certains aspects de votre fournisseur d'accès à Internet](/install/providers/isp/).
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style={styleDanger}>Oui<br/><small>(Voyez <Link to="/install/providers/isp/">ici</Link>)</small></td>
