...
- Si votre serveur est chez vous, vous avez sans doute accès au réseau local du serveur. Depuis ce réseau, vous pouvez vous connecter [en SSH](/admin/admin_guide/command_line) avec l'utilisateur `root`.
