...
- Savoir se connecter en root sur votre système, par exemple via [SSH](/admin/admin_guide/command_line). (Note : en étant connecté en tant qu'utilisateur `admin`, vous pouvez passer root avec `sudo su`)
