...
#### <SmallInline url='/img/thunderbird.png'/> Configurer Thunderbird Desktop
...
#### <SmallInline url='/img/k9mail.png'/> Configurer K-9 Mail / Thunderbird Mobile (sur Android)
...
#### <SmallInline url='/img/dekko-app.png'/> Configurer Dekko (sur Ubuntu Touch)
