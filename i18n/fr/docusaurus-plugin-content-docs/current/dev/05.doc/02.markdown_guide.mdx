...
```markdown
[![Logo YunoHost](/img/icons/logo-ynh.png)](/dev/doc/)
```
...
Les listes permettent d'afficher une suite de textes dans une présentation facile, c'est ainsi que sont rédigés les index tels que celui de la page de la [documentation contributeur](/dev.
...
| D'autres lignes | |![une image](/img/icons/icon-cd.jpg) | [Ou un lien](/dev) |
```
