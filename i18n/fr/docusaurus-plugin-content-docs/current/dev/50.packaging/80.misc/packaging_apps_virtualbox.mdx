...
Suivez simplement la documentation idoine pour l'[installation sur VirtualBox](/dev/packaging/misc/packaging_apps_virtualbox) puis la documentation sur la [post-installation](/category/after-installation).
