...
Nous parlerons ici de VirtualBox, pour son approche graphique facile à utiliser. Si vous préférez une interface en ligne de commande pour la gestion de la machine virtuelle, tournez-vous de préférence vers [ynh-dev](/dev/core/).
...
Suivez simplement la documentation idoine pour l'[installation sur VirtualBox](/dev/packaging/resources/packaging_apps_virtualbox) puis la documentation sur la [post-installation](/category/after-installation).
