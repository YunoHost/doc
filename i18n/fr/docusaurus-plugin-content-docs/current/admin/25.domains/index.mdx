...
Cependant, vous devez payer pour cela chaque année (environ 15€/an ... en fonction du TLD) et vous devez faire quelques configurations supplémentaires pour [mettre en place une zone DNS correcte](/admin/get_started/post_install/dns_config). L'outil de diagnostic peut vous aider à effectuer cette configuration.
...
[En savoir plus sur la configuration de la zone DNS](/admin/get_started/post_install/dns_config)
