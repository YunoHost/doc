...
*Trouvez la liste d’autres fournisseurs d’accès à Internet **[ici](/admin/self_hosting/providers/isp/)**.*
...
[Liste des ports à ouvrir](/admin/get_started/post_install/port_forwarding).

### Freebox ≤ v5

Cela se passe dans la section *Ma Freebox / Configurer mon routeur*. Il faut :

- Rediriger les [ports à ouvrir](/admin/get_started/post_install/port_forwarding) vers l'adresse locale de votre serveur YunoHost.
