---
sidebar_label: 'Configuration DNS manuelle pour OVH'
...
Il faut maintenant ajouter les redirections DNS telles que spécifiées par la [configuration standard de la zone DNS](/admin/get_started/post_install/dns_config)
...
puis effacez tout ce qui suit, et remplacez-le par la configuration générée par YunoHost comme expliqué dans [cette page](/admin/get_started/post_install/dns_config).
...
Vérifiez si votre FAI vous fournit une adresse IP dynamique [ici](/admin/get_started/providers/isp/).
