...
Il faut maintenant ajouter les redirections DNS telles que spécifiées par la [configuration standard de la zone DNS](/dns)
...
puis effacez tout ce qui suit, et remplacez-le par la configuration générée par YunoHost comme expliqué dans [cette page] (/dns).
