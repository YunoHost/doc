...
Les applications peuvent être installées et gérées au travers de l'interface web d'administration <HighlightApplications/> ou bien avec les commandes de la catégorie `yunohost app`.

<Figure alt="Liste des applications" caption="Liste d'applications dans l'interface web d'administration, avec le bouton Installer." src="/img/webadmin/apps_list.png"/>

Le catalogue des applications et leurs catégories peut être parcouru depuis l'interface web d'administration en cliquant sur le bouton <HighlightAppInstall/> dans la liste des applications, ou depuis cette documentation.

<div class="text--center">
<Button url="https://apps.yunohost.org" color="orange"><FAIcon icon='fa-cubes'/> Catalogue d'applications </Button>
</div>
