...
Les applications peuvent être installées et gérées au travers de l'interface web d'administration <HighlightApplications/> ou bien avec les commandes de catégorie `yunohost app`.

<Figure alt="Apps list" caption="Liste d'Applications dans l'interface web d'administration, avec le bouton Installer." src="/img/webadmin/apps_list.png"/>
