...
- Assurez-vous d'avoir [configuré les redirections de ports](/admin/install/post_install/port_forwarding)
...
Il vous faut configurer vos enregistrement DNS comme expliqué sur [cette page](/admin/install/post_install/dns_config) (à minima l'enregistrement A, et AAAA si vous avez de l'IPv6).
