...
- **Inconvénients** : il vous faudra [configurer manuellement votre box internet](/admin/install/post_install/port_forwarding) et serez possiblement [limité par certains aspects de votre fournisseur d'accès à Internet](/admin/install/providers/isp/).
...
Vous pouvez louer un serveur privé virtuel ou une machine dédiée à des hébergeurs [associatifs](https://db.ffdn.org/) ou [commerciaux](/admin/install/providers/servers).
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style={styleDanger}>Oui<br/><small>(Voyez <Link to="/admin/install/providers/isp/">ici</Link>)</small></td>
