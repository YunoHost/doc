...
**NB : Actuellement, la passerelle IRC ([grace à Matrix](https://libera.chat/guides/faq#are-bridges-allowed)) est désactivé. Alors que les canaux XMPP et Matrix sont connectés, le canal IRC ne l'est pas**.
