...
Nous parlerons ici de VirtualBox, pour son approche graphique facile à utiliser. Si vous préférez une interface en ligne de commande pour la gestion de la machine virtuelle, tournez-vous de préférence vers [ynh-dev](/contribute/core/).
...
Suivez simplement la documentation idoine pour l'[installation sur VirtualBox](/contribute/apps/resources/packaging_apps_virtualbox) puis la documentation sur la [post-installation](/category/after-installation).
...
Ce nom de domaine n'étant enregistré dans aucun serveur DNS, on l'enregistrera dans le fichier `hosts` de l'ordinateur qui y accédera. Voir la documentation sur le [DNS local](/admin/tutorials/domains/dns_local_network).
...
![](/img/softwares/virtualbox_packaging1-fr.jpg)

Et on crée un premier instantané  
![](/img/softwares/virtualbox_packaging2-fr.jpg)
...
![](/img/softwares/virtualbox_packaging3-fr.jpg)
...
![](/img/softwares/virtualbox_packaging4-fr.jpg)
...
![](/img/softwares/virtualbox_packaging5-fr.jpg)
