...
Vous pouvez utiliser la syntaxe Markdown, consultez la page de [documentation dédiée](/contribute/write_documentation/markdown_guide) pour plus d'information.
