...
```markdown
[Page du wiki](/contribute/write_documentation/)
```
...
```markdown
[![Logo YunoHost](/img/logo.png)](/contribute/write_documentation/)
```
...
| D'autres lignes | |![une image](/img/cd.jpg) | [Ou un lien](/contribute) |
```
