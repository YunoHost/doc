...
- **Минусы** : вам придется [вручную настроить свой роутер](/admin/install/post_install/port_forwarding) и [возможные ограничения вашим провайдером](/admin/install/providers/isp/).
...
Вы можете арендовать виртуальный частный сервер (VPS) или выделенную машину у [ассоциации](https://db.ffdn.org/) или [коммерческие](/admin/install/providers/servers) облачные провайдеры.
