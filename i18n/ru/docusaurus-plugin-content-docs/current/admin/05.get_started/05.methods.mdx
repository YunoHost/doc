...
- **Минусы** : вам придется [вручную настроить свой роутер](/admin/install/post_install/port_forwarding) и [возможные ограничения вашим провайдером](/admin/self_hosting/providers/isp/).
