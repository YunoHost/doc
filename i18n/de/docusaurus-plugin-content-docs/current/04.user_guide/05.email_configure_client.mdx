...
#### <SmallInline url='/img/thunderbird.png'/> Thunderbird Desktop konfigurieren (auf einem Desktop-Computer)
...
#### <SmallInline url='/img/k9mail.png'/> K-9 Mail / Thunderbird Mobile konfigurieren (auf Android)
...
#### <SmallInline url='/img/dekko-app.png'/> Dekko konfigurieren (auf Ubuntu Touch)
