...
Wir sind nun bereit, mit der [Postinstallation](/install/post_install/configuration) zu beginnen.
...
Dann musst du dein Administratorkennwort eingeben, das du unter [Post-Installationsschritt](/install/post_install/configuration) erstellt hast.
...
N.B.: `fail2ban` sperrt deine IP für 10 Minuten, wenn du 5 fehlgeschlagene Login-Versuche durchführst. Wenn du die IP-Sperre aufheben willst, schau dir die Seite über [Fail2Ban](/administer/troubleshooting/fail2ban) an.

Eine ausführlichere Diskussion über Sicherheit & SSH findest du auf der [dedicated page](/administer/tutorials/security).
