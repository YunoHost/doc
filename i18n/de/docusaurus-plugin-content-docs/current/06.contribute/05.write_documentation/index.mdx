...
{/* TODO: migrate this doc to docusaurus */}
...
Sie können die Markdown-Syntax verwenden. Weitere Informationen finden Sie in der [Dokumentation](/contribute/write_documentation/markdown_guide).
...
| --------------- | ------- | ------- |
| Apps-Katalog | `/pages/02.applications/01.catalog/apps.md` | Ruft [app.json](https://github.com/YunoHost/apps/blob/master/apps.toml) ab und verarbeitet sie |
