...
- **Cons**  : Sie müssen [Ihre Internet-Router manuell konfigurieren](/admin/install/post_install/port_forwarding) und [sind möglicherweise von Ihrem Internet-Service-Provider eingeschränkt](/admin/install/providers/isp/).
...
Sie können einen virtuellen privaten Server oder eine dedizierte Maschine von [associative](https://db.ffdn.org/) oder von anderen [kommerziellen](/admin/install/providers/servers) "Cloud"-Anbietern mieten.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style={styleDanger}>Yes<br/><small>(see <Link to="/admin/install/providers/isp">here</Link>)</small></td>
