...
- **Cons**  : Sie müssen [Ihre Internet-Router manuell konfigurieren](/admin/get_started/post_install/port_forwarding) und [sind möglicherweise von Ihrem Internet-Service-Provider eingeschränkt](/admin/self_hosting/providers/isp/).
...
Sie können einen virtuellen privaten Server oder eine dedizierte Maschine von [associative](https://db.ffdn.org/) oder von anderen [kommerziellen](/admin/self_hosting/providers/servers) "Cloud"-Anbietern mieten.
