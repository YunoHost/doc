...
- **Cons**  : Sie müssen [Ihre Internet-Router manuell konfigurieren](/admin/install/post_install/port_forwarding) und [sind möglicherweise von Ihrem Internet-Service-Provider eingeschränkt](/admin/self_hosting/providers/isp/).
