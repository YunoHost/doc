...
- leiten Sie Ports weiter, wie in [dieser Dokumentation](/admin/get_started/post_install/port_forwarding) beschrieben;
- Mail-DNS-Einträge nach [dieser Dokumentation](/admin/get_started/post_install/dns_config) sorgfältig konfigurieren;
