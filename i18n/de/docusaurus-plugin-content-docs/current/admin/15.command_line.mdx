...
Wir sind nun bereit, mit der [Postinstallation](/admin/get_started/post_install/configuration) zu beginnen.
...
Dann musst du dein Administratorkennwort eingeben, das du unter [Post-Installationsschritt](/admin/get_started/post_install/configuration) erstellt hast.
