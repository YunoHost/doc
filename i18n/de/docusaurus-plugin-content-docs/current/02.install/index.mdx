...
- **Cons**  : Sie müssen [Ihre Internet-Router manuell konfigurieren](/install/post_install/port_forwarding) und [sind möglicherweise von Ihrem Internet-Service-Provider eingeschränkt](/install/providers/isp/).
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style={styleDanger}>Yes<br/><small>(see <Link to="/install/providers/isp">here</Link>)</small></td>
