...
- Conoscenza della connessione come root sul server anche via [SSH](/admin/admin_guide/command_line). (Nota bene: se siete connessi come utente `admin`, potete passare root con il comando `sudo su`)
