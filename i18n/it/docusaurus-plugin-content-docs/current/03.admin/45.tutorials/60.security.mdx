...
La cosa migliore da fare, se conoscete l'iso dell'[interfaccia a lina di comando (CLI)](/admin/admin_guide/command_line), è disattivare il servizio `yunohost-api`.`
