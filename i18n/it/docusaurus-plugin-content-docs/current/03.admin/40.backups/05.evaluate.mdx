...
- [creare un file di backup e salvarlo manualmente (scelta di default per YunoHost)](/admin/backups/#manual-backup)
- [backup automatizzato (scelta consigliata)](/admin/backups/backup_methods)
- [backup su disco esterno](/admin/tutorials/external_storage)
- [creazione di un'immagine o snapshot](/admin/backups/clone_filesystem)
- [salvataggio dei dati con metodo personalizzato](/admin/backups/custom_backup_methods)
