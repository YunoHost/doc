...
| [OVH](https://ovh.com/domaines)     | ✔ (testato)                  | ✘   | [Obtain an API key](/admin/get_started/providers/registrar/ovh/autodns) <br/> [Configure manually](/admin/get_started/providers/registrar/ovh/manualdns) |
| [Namecheap](https://namecheap.com)  | ✘ (in lexicon ma non testato) | ✘✘✘ API not available without 50$ on the account | [Obtain an API key](/admin/get_started/providers/registrar/namecheap) |
