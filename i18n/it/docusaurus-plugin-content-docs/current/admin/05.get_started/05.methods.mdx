...
- **Contro**: dovrai [configurare manualmente il router](/admin/install/post_install/port_forwarding) e probabilmente ci saranno dei [limiti rispetto al tuo fornitore di accesso a internet](/admin/self_hosting/providers/isp/)
