...
- **Contro**: dovrai [configurare manualmente il router](/admin/get_started/post_install/port_forwarding) e probabilmente ci saranno dei [limiti rispetto al tuo fornitore di accesso a internet](/admin/get_started/providers/isp/)
