...
di errori e attacchi dall'esterno. È preferibile, se desiderate effettuare dei test, utilizzare una [macchina virtuale](https://yunohost.org/en/admin/install/hardware:virtualbox) con un'altra istanza.
:::
