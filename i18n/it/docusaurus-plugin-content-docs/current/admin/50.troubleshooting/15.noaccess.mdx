...
- Assicurati di aver [impostato il forwarding](/admin/install/post_install/port_forwarding).
...
Devi configurare i tuoi [record DNS](/admin/install/post_install/dns_config) (come minimo i record `A` e `AAAA` se usi una connessione IPv6).
