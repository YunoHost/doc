...
- se installate il server a casa e non utilizzate una VPN, assicuratevi che  [il vostro internet provider non blocchi la porta 25](/admin/self_hosting/providers/isp/) ;
- reindirizzate le porte [seguendo questa documentazione](/admin/get_started/post_install/port_forwarding) ;
- configurate con cura i record DNS riguardanti il servizio mail seguendo [questa documentazione](/admin/get_started/post_install/dns_config) ;
