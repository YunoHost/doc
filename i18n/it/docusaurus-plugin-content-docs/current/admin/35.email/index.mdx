...
- reindirizzate le porte [seguendo questa documentazione](/admin/install/post_install/port_forwarding) ;
- configurate con cura i record DNS riguardanti il servizio mail seguendo [questa documentazione](/admin/install/post_install/dns_config) ;
