...
|-------------------------------------|-----------------------------|---------------------------|-------|
| [Gandi](https://www.gandi.net)      | ✘ (broken)                  | ✘   | [Obtain an API key](/admin/install/providers/registrar/gandi) <br/> [See bug here](https://github.com/YunoHost/issues/issues/2419) |
| [OVH](https://ovh.com/domaines)     | ✔ (testato)                  | ✘   | [Obtain an API key](/admin/install/providers/registrar/ovh/autodns) <br/> [Configure manually](/admin/install/providers/registrar/ovh/manualdns) |
| [Namecheap](https://namecheap.com)  | ✘ (in lexicon ma non testato) | ✘✘✘ API not available without 50$ on the account | [Obtain an API key](/admin/install/providers/registrar/namecheap) |
