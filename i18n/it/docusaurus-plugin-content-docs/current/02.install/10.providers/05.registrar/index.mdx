...
| [OVH](https://ovh.com/domaines)     | ✔ (testato)                  | ✘   | [Obtain an API key](/install/providers/registrar/ovh/autodns) <br/> [Configure manually](/install/providers/registrar/ovh/manualdns) |
| [Namecheap](https://namecheap.com)  | ✘ (in lexicon ma non testato) | ✘✘✘ API not available without 50$ on the account | [Obtain an API key](/install/providers/registrar/namecheap) |
