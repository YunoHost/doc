...
- **Contro**: dovrai [configurare manualmente il router](/install/post_install/port_forwarding) e probabilmente ci saranno dei [limiti rispetto al tuo fornitore di accesso a internet](/install/providers/isp/)
...
Puoi affittare un server virtuale privato o un macchina dedicata da fornitori "Cloud" come [associazioni](https://db.ffdn.org) o [commerciali](/install/providers/servers)
