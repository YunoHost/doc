...
##### ![](/img/thunderbird.png?resize=50&classes=inline)  Configurazione di Mozilla Thunderbird (su computer desktop)
...
##### ![](/img/k9mail.png?resize=50&classes=inline) Configurazione di K-9 Mail (per Android)

Seguite le istruzioni seguenti (come per dovrete forse accettare i certificati affinché tutto funzioni correttamente):

![](/img/k9mail_config_1.png?resize=280&classes=inline)
![](/img/k9mail_config_2.png?resize=280&classes=inline)
![](/img/k9mail_config_3.png?resize=280&classes=inline)
![](/img/k9mail_config_4.png?resize=280&classes=inline)
