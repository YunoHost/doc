...
#### <SmallInline url='/img/thunderbird.png'/>  Configurazione di Thunderbird Desktop (su computer desktop)
...
##### <SmallInline url='/img/dekko-app.png'/> Configurazione di Dekko (per Ubuntu Touch)
