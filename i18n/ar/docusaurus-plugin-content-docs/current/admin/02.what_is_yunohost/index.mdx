...
Le tout est bien entendu **entièrement libre**. La philosophie de l’[الإستضافة الذاتية](/admin/self_hosting) étant à nos yeux incompatible avec tout autre modèle de développement logiciel.
