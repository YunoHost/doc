...
Les citations permettent de mettre en valeur un propos tenu par une autre personne, le wiki gere lui meme la façon dont c'est valorisé. Markdown utilise ce `>` pour annoncer une citation. Il suffit de les rajouter avant la citation, comme tel : 
```
>Du texte de citation du premier niveau
>qui peut etre formaté en différentes lignes
