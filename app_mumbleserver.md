# <img src="/images/mumbleserver_logo.svg" width="80px" alt="Mumble server's logo"> Mumble server
...
+ Official documentation: [wiki.mumble.info - wiki](https://wiki.mumble.info/wiki/Main_Page)
