...
const redirects_from_grav: Array<{ from: string; to: string }> = [
    ...
    { from: '/advanced_packagers',                      to: '/dev/packaging/advanced', },
    ...
    { from: '/packaging_apps_resources',                to: '/dev/packaging/manifest/resources', },
    { from: '/packaging_policy',                        to: '/dev/packaging/policy', },
    { from: '/packaging_publishing',                    to: '/dev/packaging/publish', },
    { from: '/packaging_apps_git',                      to: '/dev/packaging/resources/packaging_apps_git', },
    { from: '/packaging_apps_virtualbox',               to: '/dev/packaging/resources/packaging_apps_virtualbox', },
