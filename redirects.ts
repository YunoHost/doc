...
const redirects_from_grav: Array<{ from: string; to: string }> = [
    ...
    { from: '/selfhosting',                             to: '/admin/self_hosting/', },
    { from: '/providers/isp',                           to: '/admin/self_hosting/providers/isp/', },
    { from: '/providers/isp/free',                      to: '/admin/self_hosting/providers/isp/free', },
    { from: '/providers/isp/orange',                    to: '/admin/self_hosting/providers/isp/orange', },
    { from: '/providers/isp/sfr',                       to: '/admin/self_hosting/providers/isp/sfr', },
    { from: '/providers/registrar',                     to: '/admin/self_hosting/providers/registrar/', },
    { from: '/providers/registrar/gandi/autodns',       to: '/admin/self_hosting/providers/registrar/gandi', },
    { from: '/providers/registrar/namecheap/autodns',   to: '/admin/self_hosting/providers/registrar/namecheap', },
    { from: '/providers/registrar/ovh/autodns',         to: '/admin/self_hosting/providers/registrar/ovh/autodns', },
    { from: '/providers/registrar/ovh/manualdns',       to: '/admin/self_hosting/providers/registrar/ovh/manualdns', },
    { from: '/providers/server',                        to: '/admin/self_hosting/providers/servers', },
    { from: '/providers/vpn',                           to: '/admin/self_hosting/providers/vpn/', },
    { from: '/vpn_advantage',                           to: '/admin/self_hosting/providers/vpn/vpn_advantage', },
