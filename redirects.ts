...
const redirects_from_grav: Array<{ from: string; to: string }> = [
    ...
    { from: '/providers/registrar/gandi/autodns',       to: '/registrar_api_gandi', },
    { from: '/providers/registrar/namecheap/autodns',   to: '/registrar_api_namecheap', },
    { from: '/providers/registrar/ovh/autodns',         to: '/registrar_api_ovh', },
    { from: '/providers/registrar/ovh/manualdns',       to: '/registrar_api_ovh_manual', },
