...
const redirects_from_grav: Array<{ from: string; to: string }> = [
    ...
    { from: '/isp_box_config',                          to: '/admin/install/post_install/port_forwarding', },
    { from: '/providers/isp',                           to: '/admin/install/providers/isp/', },
    { from: '/providers/isp/free',                      to: '/admin/install/providers/isp/free', },
    { from: '/providers/isp/orange',                    to: '/admin/install/providers/isp/orange', },
    { from: '/providers/isp/sfr',                       to: '/admin/install/providers/isp/sfr', },
    { from: '/providers/registrar',                     to: '/admin/install/providers/registrar/', },
    { from: '/providers/registrar/gandi/autodns',       to: '/admin/install/providers/registrar/gandi', },
    { from: '/providers/registrar/namecheap/autodns',   to: '/admin/install/providers/registrar/namecheap', },
    { from: '/providers/registrar/ovh/autodns',         to: '/admin/install/providers/registrar/ovh/autodns', },
    { from: '/providers/registrar/ovh/manualdns',       to: '/admin/install/providers/registrar/ovh/manualdns', },
    { from: '/providers/server',                        to: '/admin/install/providers/servers', },
    { from: '/providers/vpn',                           to: '/admin/install/providers/vpn/', },
    { from: '/vpn_advantage',                           to: '/admin/install/providers/vpn/vpn_advantage', },
    { from: '/selfhosting',                             to: '/admin/overview/self_hosting', },
    { from: '/try',                                     to: '/admin/overview/try_yunohost', },
    { from: '/whatsyunohost',                           to: '/admin/overview/what_is_yunohost', },
