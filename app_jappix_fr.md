# <img src="/images/jappix_logo.png" width="80px" alt="logo de Jappix"> Jappix
...
## Liens utiles
 ...
 + Site web : [SITE WEB](#)
 + Documentation officielle : [github.com - jappix/Jappix](https://github.com/jappix/Jappix)
 + Dépôt logiciel de l'application : [github.com - YunoHost-Apps/jappix](https://github.com/YunoHost-Apps/jappix_ynh)
 + Remonter un bug ou une amélioration en créant un ticket (issue) : [github.com - YunoHost-Apps/jappix/issues](https://github.com/YunoHost-Apps/jappix_ynh/issues)
