...
const redirects_from_grav = [
    ...
    { from: '/packaging_apps_resources',                to: '/contribute/apps/manifest/resources', },
    { from: '/packaging_policy',                        to: '/contribute/apps/policy', },
    { from: '/packaging_publishing',                    to: '/contribute/apps/publish', },
    { from: '/packaging_apps_git',                      to: '/contribute/apps/resources/packaging_apps_git', },
    { from: '/packaging_apps_virtualbox',               to: '/contribute/apps/resources/packaging_apps_virtualbox', },
