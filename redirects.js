...
const redirects_from_grav = [
    ...
    { from: '/buster_bullseye_migration',               to: '/admin/upgrade/11.0-buster_bullseye', },
    { from: '/bullseye_bookworm_migration',             to: '/admin/upgrade/12.0-bullseye_bookworm/', },
    { from: '/bookworm_migration_issues_faq',           to: '/admin/upgrade/12.0-bullseye_bookworm/issues_faq', },
    ...
    { from: '/advanced_packagers',                      to: '/contribute/apps/advanced', },
    ...
    { from: '/dev',                                     to: '/contribute/core/', },
    { from: '/dev/forms',                               to: '/contribute/core/forms', },
    { from: '/dev/maindomain',                          to: '/contribute/core/maindomain', },
    { from: '/packaging_apps',                          to: '/contribute/apps/', },
    { from: '/packaging_config_panels',                 to: '/contribute/apps/advanced/config_panels', },
    { from: '/packaging_apps_hooks',                    to: '/contribute/apps/advanced/hooks', },
    { from: '/packaging_v2',                            to: '/contribute/apps/advanced/packaging_v2', },
    { from: '/packaging_sso_ldap_integration',          to: '/contribute/apps/advanced/sso_ldap_integration', },
    { from: '/packaging_app_doc',                       to: '/contribute/apps/doc', },
    { from: '/packaging_manifest',                      to: '/contribute/apps/manifest/', },
    { from: '/packaging_apps_resources',                to: '/contribute/apps/manifest/app_resources', },
    { from: '/packaging_policy',                        to: '/contribute/apps/policy', },
    { from: '/packaging_publishing',                    to: '/contribute/apps/publish', },
    { from: '/packaging_apps_git',                      to: '/contribute/apps/resources/apps_git', },
    { from: '/packaging_apps_virtualbox',               to: '/contribute/apps/resources/apps_virtualbox', },
    { from: '/packaging_scripts',                       to: '/contribute/apps/scripts/', },
    { from: '/packaging_apps_helpers',                  to: '/contribute/apps/scripts/helpers_v2.0', },
    { from: '/packaging_apps_helpers_v2.1',             to: '/contribute/apps/scripts/helpers_v2.1', },
    { from: '/shell_variables_scope',                   to: '/contribute/apps/scripts/shell_variables_scope', },
    { from: '/packaging_testing',                       to: '/contribute/apps/test', },
    { from: '/write_documentation',                     to: '/contribute/doc/', },
    { from: '/doc_writing_guide',                       to: '/contribute/doc/apps_documentation', },
    { from: '/doc_use_git',                             to: '/contribute/doc/git', },
    { from: '/doc_markdown_guide',                      to: '/contribute/doc/markdown_guide', },
    ...
    { from: '/finding_the_local_ip',                    to: '/install/post_install/find_ip', },
    { from: '/isp_box_config',                          to: '/install/post_install/port_forwarding', },
