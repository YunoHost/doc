...
Après avoir mis en place la solution proposée dans ce tutoriel, la redirection du nom de domaine vers l'adresse IP ne sera plus perdu.
...
Si vous possedez un nom de domaine chez **OVH**, vous pouvez aller à l'étape 4 et suivre ce [tutoriel](OVH_fr) étant donné qu'OVH propose un service de DynDNS.
...
Redirigez le champs NS vers l'adresse IP donnée par le service de DynDNS.
