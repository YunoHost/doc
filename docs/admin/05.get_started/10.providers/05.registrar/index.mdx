...
| [OVH](https://ovh.com/domaines)     | ✔ (tested)                  | ✘   | [Obtain an API key](/admin/self_hosting/providers/registrar/ovh/autodns) <br/> [Configure manually](/admin/self_hosting/providers/registrar/ovh/manualdns) |
| [Namecheap](https://namecheap.com)  | ✘ (in lexicon but untested) | ✘✘✘ API not available without 50$ on the account | [Obtain an API key](/admin/self_hosting/providers/registrar/namecheap) |
