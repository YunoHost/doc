...
<Tabs groupId="domain-choice">
  <TabItem value="yunohost-domains" label="YunoHost's free domains">
  ...
  [more details on YunoHost's free domains](/admin/tutorials/domains/dns_nohost_me)

  </TabItem>
  <TabItem value="own-domain" label="Your own domain">
  ...
  <TabItem value="local-domain" label="Local domains">
