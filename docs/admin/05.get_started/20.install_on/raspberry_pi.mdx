...
<TabItem value="gnome-disk" label="With Gnome Disk">

If you are on GNU/Linux Gnome based distribution like Ubuntu 24 or Debian with Gnome you can use [gnome-disk utility](https://apps.gnome.org/en/DiskUtility/) to restore your image on your card.
