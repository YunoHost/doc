...
<TabItem value="os-specific" label="OS Specific">

Many OS provide tools to create usb images, then don't require to install additional software, some are documented bellow.

# Gnome OS / Ubuntu - Debian

If you are on GNU/Linux Gnome based distribution like Ubuntu 24 or Debian with Gnome you can use [gnome-disk utility](https://apps.gnome.org/en/DiskUtility/) to write your image on your card.

[A video in french displays this](https://pire.artisanlogiciel.net/w/hVFbXUW7yYbGzP2BLmDgVP?start=3m11s)

# Mint

Linux Mint provides a USB Image writer

![Mint USB Image writer](https://linuxmint-installation-guide.readthedocs.io/en/latest/_images/mintstick.png)
