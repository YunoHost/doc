...
:::note
If you wish to install it on a Raspberry Pi 2, you can either
  - follow this guide but with older image from Debian Buster ([Download here](https://repo.yunohost.org/images/attic/yunohost-buster-4.1.7.1-rpi-stable.img.zip)) and then  [upgrade the system](/admin/tutorials/upgrade)
  - or install the RaspberryPi with no desktop such as [lite OS](https://www.raspberrypi.com/software/operating-systems/) and then follow the [On top of debian Guide](/admin/get_started/install_on/on_top_of_debian)
:::
