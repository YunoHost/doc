...
pagination_next: admin/get_started/post_install/configuration
...
You can now go through [the initial post-install configuration](/admin/get_started/post_install/configuration).
