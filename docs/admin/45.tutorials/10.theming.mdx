...
The portal is customizable from the webadmin on page Domains on the portal domain (top domain by defaut)
...
All apps from all domains will be visible on the portal
