...
If you own a domain name at **OVH**, you may go to step 4 and follow this [tutorial](/registrar_api_ovh_manual), given that OVH proposes a DynDNS service.
...
Copy the [DNS zones](/dns), except for the NS fields, from the [registrar](#registrars) where you bought your domain name from to the dynamic DNS service you registrer at in step 1.
...
Then, remove any other item in the [DNS zones](/dns) (except the previous NS fields), from the [registrar](#registrars).
