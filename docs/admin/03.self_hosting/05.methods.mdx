...
- **Cons**: you will have to [manually configure your internet box](/admin/install/post_install/port_forwarding) and [might be limited by your ISP](/admin/self_hosting/providers/isp/).
