...
- **Cons**: you will have to [manually configure your internet box](/admin/install/post_install/port_forwarding) and [might be limited by your ISP](/admin/install/providers/isp/).
...
You can rent a virtual private server or a dedicated machine from [associative](https://db.ffdn.org/) or [commercial](/admin/install/providers/servers) "Cloud" providers.
