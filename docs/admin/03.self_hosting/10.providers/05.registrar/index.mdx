...
| [OVH](https://ovh.com/domaines)     | ✔ (tested)                  | ✘   | [Obtain an API key](/admin/install/providers/registrar/ovh/autodns) <br/> [Configure manually](/admin/install/providers/registrar/ovh/manualdns) |
| [Namecheap](https://namecheap.com)  | ✘ (in lexicon but untested) | ✘✘✘ API not available without 50$ on the account | [Obtain an API key](/admin/install/providers/registrar/namecheap) |
