...
To interact with the email sever (read and send emails), you can either install a webclient such as Roundcube or Rainloop on your server - or configure a desktop/mobile client as described in [this page](/admin/email/email_clients).
...
See [this page](/admin/email/email_migration).
