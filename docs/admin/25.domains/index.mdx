...
In order to make self-hosting as accessible as possible, the YunoHost Project provides a *free* and *automatically configured* domain name service. By using this service, you won't have to [configure DNS records](/dns) yourself, which can be tedious and technical.
...
However, you have to pay for it each year (about 15€/year ... depending on the TLD) and you have to do some extra configuration to [setup a correct DNS zone](/dns). Our diagnosis tool can trigger alert to help you to do this configuration.
...
[Know more on DNS zone configuration](/dns)
