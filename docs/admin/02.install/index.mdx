...
- **Cons**: you will have to [manually configure your internet box](/install/post_install/port_forwarding) and [might be limited by your ISP](/install/providers/isp/).
