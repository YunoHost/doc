...
sidebar_custom_props:
  doc_card_image: /img/icons/logo-virtualbox.png
---
...
- A [reasonable ISP](/admin/install/post_install/port_forwarding), preferably with a good and unlimited upstream bandwidth
