...
- Make sure you have [set up forwarding](/admin/install/post_install/port_forwarding)
...
You have to configure your [DNS records](/admin/install/post_install/dns_config) (at least `A` records, and `AAAA` if you have an IPv6 connection).
