...
- if you are self-hosting at home and not using a VPN, ensure [your ISP won't block port 25](/admin/self_hosting/providers/isp/) ;
- route ports according to [this documentation](/admin/install/post_install/port_forwarding) ;
- carefully configure mail DNS records according to [this documentation](/admin/install/post_install/dns_config) ;
...
To interact with the email sever (read and send emails), you can either install a webclient such as Roundcube or Rainloop on your server - or configure a desktop/mobile client as described in [this page](/admin/emails/email_clients).
...
See [this page](/admin/emails/email_migration).
