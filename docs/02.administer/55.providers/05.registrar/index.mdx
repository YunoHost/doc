...
|-------------------------------------|-----------------------------|---------------------------|-------|
| [Gandi](https://www.gandi.net)      | ✘ (broken)                  | ✘   | [Obtain an API key](/providers/registrar/gandi/autodns) <br/> [See bug here](https://github.com/YunoHost/issues/issues/2419) |
...
| [Namecheap](https://namecheap.com)  | ✘ (in lexicon but untested) | ✘✘✘ API not available without 50$ on the account | [Obtain an API key](/providers/registrar/namecheap/autodns) |
