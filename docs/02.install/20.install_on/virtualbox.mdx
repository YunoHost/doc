...
sidebar_custom_props:
  doc_card_image: /img/virtualbox.png
---
...
- A [reasonable ISP](/install/post_install/port_forwarding), preferably with a good and unlimited upstream bandwidth
