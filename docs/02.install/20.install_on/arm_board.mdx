...
## <img src="/img/sdcard_with_adapter.png" height="40" alt="microSD card with adapter"/> Flash the Armbian image
...
Next you need to [find the local IP address of your server](/finding_the_local_ip) to connect as root user [via SSH](/administer/admin_guide/command_line) with the temporary password `1234`.
