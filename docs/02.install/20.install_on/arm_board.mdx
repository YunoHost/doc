...
Next you need to [find the local IP address of your server](/install/post_install/finding_the_local_ip) to connect as root user [via SSH](/admin/command_line) with the temporary password `1234`.
