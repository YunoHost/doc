...
:::tip
If you are in the process of restoring a server using a YunoHost backup, you should skip this step and instead [restore the backup instead of the postinstall step](/administer/backups/#restoring-backups).
:::
