...
If you're using an [automatic domain](/administer/tutorials/domains/dns_nohost_me) provided by the YunoHost Project, the configuration should be
...
If your global IP address is constantly changing, follow this [tutorial](/administer/tutorials/domains/dns_dynamicip).
