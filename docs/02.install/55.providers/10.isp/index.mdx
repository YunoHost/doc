...
| Fournisseur d’accès | Box/ routeur | uPnP activable | [Port 25 ouvrable](../../tour/email)| [Hairpinning](http://fr.wikipedia.org/wiki/Hairpinning) | [Reverse DNS](https://en.wikipedia.org/wiki/Reverse_DNS_lookup) | IP fixe |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
...
| Service provider | Box/ router | uPnP beschikbaar | [Poort 25 openen mogelijk](../../tour/email)| [Hairpinning](http://fr.wikipedia.org/wiki/Hairpinning) | [Reverse DNS](https://en.wikipedia.org/wiki/Reverse_DNS_lookup) | vaste IP |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
...
| Fournisseur d’accès   | **Box/routeur**          | **[UPnP](https://fr.wikipedia.org/wiki/Universal_Plug_and_Play)** | **[Port 25 ouvrable](../../tour/email)**<br/> | **[Hairpinning](http://fr.wikipedia.org/wiki/Hairpinning)** | **[Reverse DNS](https://en.wikipedia.org/wiki/Reverse_DNS_lookup)<br/>personnalisable ** | **[IP fixe](../../network-setup/dynamicip)**                                       | **[IPv6](https://fr.wikipedia.org/wiki/IPv6)** | **[Non listé sur le DUL](https://en.wikipedia.org/wiki/Dialup_Users_List)** |
|-----------------------|--------------------------|-------------------------------------------------------------------|--------------------------------------------------------|-------------------------------------------------------------|------------------------------------------------------------------------------------------|---------------------------------------------------------------------|------------------------------------------------|-----------------------------------------------------------------------------|
