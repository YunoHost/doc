...
Simply follow the appropriate documentation for [installing on VirtualBox](/dev/packaging/resources/packaging_apps_virtualbox) then the [post-installation](/category/after-installation) guide.
