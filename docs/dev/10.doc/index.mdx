...
- **Translations** are inside `i18n` folders, for example the "What is YunoHost" page translated to french is in `i18n/fr/docusaurus-plugin-content-docs/current/admin/02.what_is_yunohost/index.mdx`
