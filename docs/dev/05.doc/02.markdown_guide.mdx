...
```markdown
![YunoHost Logo](/img/icons/logo-ynh.png)
```
...
```markdown
[![YunoHost Logo](/img/icons/logo-ynh.png)](/contribute/doc/)
```
...
| More lines | |![An image](/img/icons/icon-cd.jpg) | [Or a link](/contribute/) |
```
