...
```markdown
![YunoHost Logo](/img/icons/logo-ynh.svg)
```
...
```markdown
[![YunoHost Logo](/img/icons/logo-ynh.svg)](/dev/doc/)
```
...
Lists allow to display a series of texts in an easy presentation, this is how indexes such as the [contributing documentation](/dev/) page are written.
...
| More lines | |![An image](/img/icons/icon-cd.jpg) | [Or a link](/dev/) |
```
