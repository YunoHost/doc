...
<LinkButton url="https://forum.yunohost.org/?target=_blank&classes=btn,btn-lg,btn-success" color="green"><FAIcon icon='fa-comment'/> Go to the forum</LinkButton>
</div>
...
<div class="text--center">
  <LinkButton url="https://github.com/yunohost/issues/issues?target=_blank&classes=btn,btn-lg,btn-warning" color="red"><FAIcon icon='fa-exclamation-circle'/> Report a bug in YunoHost's core</LinkButton>
  {' '}
  <LinkButton url="https://github.com/YunoHost-Apps?target=_blank&classes=btn,btn-lg,btn-warning" color="orange"><FAIcon icon='fa-exclamation-circle'/> Report a bug in one of YunoHost's apps</LinkButton>
  {' '}
  <LinkButton url="https://web.libera.chat/#yunohost-dev&classes=btn,btn-lg,btn-warning" color="lightblue"><FAIcon icon='fa-comment'/> Contact the developers</LinkButton>
</div>
