...
- &#8203;<SmallInline url='/img/icons/icon-debian.png' alt="debian logo"/> Based on Debian
- &#8203;<SmallInline url='/img/icons/icon-tools.png' alt="tools logo"/> Administer your server through a **friendly web interface**
- &#8203;<SmallInline url='/img/icons/icon-package.png' alt="package logo"/> Deploy **apps in just a few clicks**
