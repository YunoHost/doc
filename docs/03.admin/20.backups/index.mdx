...
It is possible to use `scp` (a program based on [`ssh`](/admin/admin_guide/command_line)) to copy files between two machines via the command line. So, from a GNU/Linux machine, you can use the following command to download an archive:
