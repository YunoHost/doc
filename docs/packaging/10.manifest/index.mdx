...
:::tip
If you want to convert an application from the packaging v1 to v2 format, [please see here](/contribute/apps/advanced/packaging_v2)!
:::
...
The full documentation on resources is available [here](/contribute/apps/manifest/resources).
