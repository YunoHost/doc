...
```markdown
[Wiki Page](/contribute/contribute/write_documentation//)
```
...
[Wiki page](/contribute/write_documentation/)
...
[My Anchor Returns to Lists](#lists)
...
```markdown
[![YunoHost Logo](/img/logo.png)](/contribute/write_documentation/)
[![YunoHost Logo](/img/logo.png)](/contribute/write_documentation/)
```
...
Lists allow to display a series of texts in an easy presentation, this is how indexes such as the [contributing documentation](/contribute/) page are written.
Lists allow to display a series of texts in an easy presentation, this is how indexes such as the [contributing documentation](/contribute/) page are written.
...
{useBrokenLinks().collectAnchor("anchorname")}
### <span id="anchorname">Unordered lists</span>
...
| More lines | |![An image](/img/cd.jpg) | [Or a link](/contribute/) |
```
