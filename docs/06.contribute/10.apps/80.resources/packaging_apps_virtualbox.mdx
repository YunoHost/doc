...
We will discuss VirtualBox in this guide, as it comes with an easy to use GUI. If you prefer a pure commandline approach to handling your virtual machine, you should use [ynh-dev](/contribute/core/) instead.
...
Simply follow the appropriate documentation for [installing on VirtualBox](/contribute/apps/resources/packaging_apps_virtualbox) then the [post-installation](/category/after-installation) guide.
