# Propel a contribution with Git

  **Index**
 - [Creating an account on github.com](#CreationAccountGithub)
 - [Fork the YunoHost documentation into your personal repository](#ForkerDocumentationYunoHost)
 - [Edit files and add your contributions](#EditAddContrib)
 - [Send your contributions with a Pull Request](#SendPR)
 - [Track your contribution and take into account feedback from contributors](#TrackContributions)
 - [Bringing up errors and wishes by creating a way out](#RemonterIssues)
 - [Correct and Inspect Contributions](#ReviewContrib)
 - [Going further with Git and working locally on his computer](#PlusLoinGitOrdi)
 - [Some web resources](#WebLinks)
...
## Create an account on github.com <a name="CreationCompteGithub"></a>
...
## Fork the YunoHost documentation in your personal repository <a name="ForkerYunoHostDocumentation"></a>
...
## Modify and add your contribution <a name="ModifyAddContrib"></a>
...
## Send your contribution by a Pull Request <a name="SendPR"></a>
...
## Track your contribution and take into account feedback from contributors <a name="TrackContributions"></a>
...
## Bringing up mistakes and wishes through issues <a name="Bringing upIssues"></a>
...
## Going further with Git and working on his workstation <a name="PlusLoinGitOrdi"></a>
...
## Some resources elsewhere on the net to go further <a name="WebLinks"></a>
